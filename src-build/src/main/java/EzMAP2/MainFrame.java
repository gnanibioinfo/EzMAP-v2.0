...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        super("EzMAP v2.0 — Easy Microbiome Analysis Pipeline");
    ...
    private JComponent buildSidebar() {
        ...
        JLabel logoIcon = createEzCircleLabel(46, 19f);
        ...
        // "EzMAP" at full size with a smaller "v2.0" suffix.
        JLabel nameLabel = new JLabel("<html>EzMAP <small>v2.0</small></html>");
        nameLabel.setFont(Theme.FONT_BRAND.deriveFont(Font.BOLD, 22f));
        nameLabel.setForeground(Color.WHITE);
        // Wrap the full name so "Pipeline" is never clipped in the narrow sidebar.
        JLabel subLabel = new JLabel(
                "<html><div style='width:150px'>Easy Microbiome Analysis Pipeline</div></html>");
        subLabel.setFont(Theme.FONT_BRAND_SUB.deriveFont(Font.BOLD, 10f));
    ...
    private JComponent buildTopBar() {
        ...
        GhostButton aboutBtn = new GhostButton("About");
        aboutBtn.addActionListener(e -> new AboutPage(MainFrame.this).setVisible(true));
