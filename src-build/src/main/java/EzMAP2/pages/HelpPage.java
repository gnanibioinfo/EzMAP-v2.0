...
public class HelpPage extends JDialog {
    ...
    public HelpPage(Frame owner) {
        super(owner, "EzMAP v2.0 \u2014 Technical Reference & Help", true);
        setSize(820, 700);
        ...
        JLabel title = new JLabel("\uD83D\uDCD6  EzMAP v2.0 Technical Reference");
    ...
    private JScrollPane buildVersionsTab() {
        ...
        panel.add(paramTable(new String[][]{
            {"EzMAP v2.0",               "2.0",        "Java Swing GUI + R Shiny downstream"},
        ...
        panel.add(Box.createVerticalStrut(16));
        panel.add(noteLabel(
                "Exact versions depend on the QIIME2 release installed. EzMAP v2.0 detects the installed QIIME2 version "
    ...
    private JScrollPane buildRationaleTab() {
        ...
        panel.add(wrapLabel(
                "The Easy Mode defaults in EzMAP v2.0 are optimized for stability and reproducibility across typical "
        ...
        panel.add(rationale("Smart Trim (quality-driven truncation)",
                "Rather than using fixed truncation lengths, EzMAP v2.0 analyzes per-base quality distributions from "
        ...
        panel.add(rationale("Naive Bayes classifier (classify-sklearn)",
                ...
                + "BLAST-based and VSEARCH-based methods for taxonomy assignment. EzMAP v2.0 trains classifiers against the "
