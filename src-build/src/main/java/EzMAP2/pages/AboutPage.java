 ...
 *     (Java, QIIME 2, R + downstream packages, FUNGuild, SpiecEasi)
...
public class AboutPage extends JDialog {
    ...
    private JPanel buildUsageTab() {
        ...
        p.add(sectionTitle("4. FUNGuild (functional guilds for fungal/ITS data)"));
        ...
        p.add(sectionTitle("5. SpiecEasi (microbial co-occurrence networks)"));
