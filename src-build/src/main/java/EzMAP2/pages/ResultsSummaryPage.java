...
public class ResultsSummaryPage extends BasePage {
    ...
    // Downstream launch
    private final PrimaryButton launchBtn   = new PrimaryButton("Open in EzMAP v2 Downstream  \u2192");
    ...
    public ResultsSummaryPage(WizardController wizard) {
        ...
        JLabel folderHint = new JLabel("<html><body style='width:640px'>" +
                "Browse to the folder containing your EzMAP v2 pipeline output. " +
        ...
        InfoBanner instructions = new InfoBanner(InfoBanner.Kind.INFO,
                ...
                "Click 'Open in EzMAP v2 Downstream' to launch the interactive Shiny module. " +
    ...
    private void launchShiny() {
        ...
        console.clear();
        console.info("Starting EzMAP v2 Downstream (Shiny)\u2026");
