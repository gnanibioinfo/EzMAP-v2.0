    ...
    output$render_instructions <- renderUI({
        ...
        message_list <- switch(state,
            "waiting_upload" = list(
                ...
                text  = "Upload your required files (BIOM, metadata, tree) in the panel on the left. EzMAP v2.0 will automatically construct the <b>phyloseq object</b> that powers every downstream step."
            ),
            "data_loaded" = list(
