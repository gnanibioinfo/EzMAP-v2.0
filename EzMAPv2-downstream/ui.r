################################################################################
# ui.R — EzMAP v2 Downstream Analysis UI
...
ui <- bslib::page_navbar(
    ...
    title = span(
        ...
        span("EzMAP v2", style = "letter-spacing:0.3px;")
    ),
        ...
        tags$script(HTML("
            ...
            (function injectEzOverlay() {
                ...
                ov.innerHTML =
                    ...
                    '<div id=\"ez-loading-title\">Loading EzMAP v2 Downstream Analysis...</div>' +
    ...
    tabPanel("Welcome", icon = icon("home"), value = "tab_welcome",
        ...
        div(class = "welcome-container",
            ...
            h2("Welcome to EzMAP v2 — Downstream Analysis"),
            p(class = "subtitle",
            ...
            div(style = "max-width:760px; margin:8px auto 22px auto; text-align:left; font-size:14px; color:#475569; line-height:1.55;",
                tags$p(
                    "This is the ", tags$b("downstream"), " module of EzMAP v2 — an ",
                ...
                column(8, offset = 2,
                    bslib::card(class = "card-results",
                        ...
                        div(style = "padding: 16px;",
                            tags$p("EzMAP v2 is an interactive Shiny-based web application for ",
                                   "16S rRNA and ITS amplicon sequencing data analysis. It provides a complete ",
                                   "Easy Microbiome Pipeline from data upload through diversity analysis, ",
                            ...
                            div(style = "text-align:center; margin-top:20px; padding-top:12px; border-top:1px solid var(--ez-gray-200);",
                                tags$p(style = "color:var(--ez-gray-400); font-size:11px; margin:0;",
                                       "Easy Microbiome Pipeline | Developed for reproducible microbiome research")
                            )
                        )
                    )
                )
    ...
    footer = div(class = "app-footer",
        span(icon("flask"), strong(" EzMAP v2"), " \u2014 Easy Microbiome Pipeline"),
